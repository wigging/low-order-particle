...
py.figure(1)
py.plot(t, TdsvH[:, 0], 'b-', lw=2, label='Tc_dsv')
py.plot(t, Tdsv[:, 0], 'r-', lw=2, label='Tc_dsv, H=0')
py.plot(t1, Tsph+273, 'go', mec='g', mew=2, label='expmt')
...
py.figure(2)
py.plot(t, Ys_dsvH, 'b-', lw=2, label='Ys_dsv')
py.plot(t, Ys_dsv, 'r-', lw=2, label='Ys_dsv, H=0')
py.plot(t2, Msph, 'go', mec='g', mew=2, label='expmt')
py.ylim([0, 1.1])
py.xlabel('Time (s)')
