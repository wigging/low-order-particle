"""
Compare temperature profiles of 1-D and 3-D models for DF = 200 um dry white oak
...
H = 1.8914e-4   # height of Comsol particle, m
W = 6.9766e-5   # width of Comsol particle, m
L = 8.8923e-5   # length of Comsol particle, m

# 1-D Transient Heat Conduction in Biomass Particle
# -----------------------------------------------------------------------------
...
txtfile = 'comsol/200tempsOak.txt'
...
py.ylim(250, 800)
py.xlim(0, tmax)
py.title('1-D (Dsv) vs 3-D Temperatures for DF = 200 um')
py.ylabel('Temperature (K)')
py.xlabel('Time (s)')
